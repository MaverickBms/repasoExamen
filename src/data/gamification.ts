...
export const BADGES: BadgeDef[] = [
  {
    id: "primer-paso",
    title: "Primer paso",
    description: "Completa tu primera actividad interactiva.",
    icon: "check",
  },
  {
    id: "ejercicio-hecho",
    title: "Ejercicio resuelto",
    description: "Responde o reflexiona sobre un ejercicio de la guía.",
    icon: "code",
  },
  {
    id: "simulacro-hecho",
    title: "Simulacro entregado",
    description: "Completa el simulacro del capítulo 13.",
    icon: "timer",
  },
  {
    id: "simulacro-fuerte",
    title: "Base sólida",
    description: "Acierta al 70 % o más de las partes evaluables del simulacro.",
    icon: "trophy",
  },
  {
    id: "banco-practica",
    title: "Entrenador",
    description: "Reflexiona sobre 5 preguntas del banco (cap. 12) en una sesión.",
    icon: "bank",
  },
  {
    id: "desafio-dia",
    title: "Desafío del día",
    description: "Completa el desafío diario de reflexión.",
    icon: "flag",
  },
  {
    id: "racha-3",
  ...
  },
  {
    id: "checklist-10",
    title: "Ya casi",
    description: "Marca 10 elementos del checklist final.",
    icon: "check",
  },
  {
    id: "checklist-completo",
    title: "Listo para el examen",
    description: "Completa los 30 elementos del checklist del capítulo 16.",
    icon: "trophy",
  },
  {
    id: "ruta-completa",
    title: "Ruta recorrida",
    description: "Marca los 10 módulos como revisados.",
    icon: "road",
  },
  {
    id: "arquitecto",
    title: "Arquitecto",
    description: "Alcanza el nivel Architect.",
    icon: "diagram",
  },
];